...
public class TwitchChannel
{
    ...
    public static final String API_URL = "https://api.twitch.tv/kraken/channels/";
...
//        }
    ...
    {
        String channelId = TwitchUserInfo.getTwitchUserInfo(channelName).getId();
        String data = Network.getJSON(API_URL + channelId);
        JsonObject p = new Gson().fromJson(data, JsonObject.class);
        System.out.println(p);

        TwitchChannel msg = new Gson().fromJson(p, TwitchChannel.class);
