 ...
 * Created by teocci.
 *
 * @author teocci@yandex.com on 2018-Jun-07
 */

public class PromptingTaskTest extends Application
{
    private static final String[] SAMPLE_TEXT = ("MISSING Lorem ipsum dolor sit amet MISSING consectetur adipisicing " +
            "elit sed do eiusmod tempor incididunt MISSING ut labore et dolore magna aliqua").split(" ");
