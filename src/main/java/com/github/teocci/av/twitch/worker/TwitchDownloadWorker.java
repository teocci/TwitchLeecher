...
import com.github.teocci.av.twitch.exceptions.TwitchDownloadException;
...
public class TwitchDownloadWorker extends SwingWorker<Void, Void>
{
    ...
    /**
     * Method Stub, implement useful Download when ready.
     *
     * @return
     * @throws Exception
     */
...
//            System.out.printf("Open Connection to %s\n", url.toString());
            ...
            System.out.printf(
                    "Downloading \"%s\"\t content length = %10d byte\n from: %s\n",
...
//            System.out.println("Downloading " + file);
            ...
            System.err.printf(
                    "TimeOut at %.2f%% restarting download of %s\n URL: %s\n",
                    percent,
                    destinationFile.getName(),
                    url.toString()
